...
// const { ETHEREUM } = require('../../config/networks');
...
//     this.provider = new ethers.JsonRpcProvider(ETHEREUM.rpc[network]);
//     this.explorerApi = ETHEREUM.explorerApi[network];
...
//       return tx.hash;
//     } catch (error) {
//       console.error('ETH transaction error:', error.message);
...
//       }));
//     } catch (error) {
//       console.error('Error getting ETH transaction history:', error.message);
//       return [];
//     }
//   }
...
//         estimatedFee: ethers.formatEther(gasCost) + ' ETH'
//       };
//     } catch (error) {
