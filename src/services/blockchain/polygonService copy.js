...
// const { POLYGON } = require('../../config/networks');
...
//     this.provider = new ethers.JsonRpcProvider(POLYGON.rpc[network]);
//     this.explorerApi = POLYGON.explorerApi[network];
//     this.apiKey = process.env.POLYGONSCAN_API_KEY;
//   }

//   /**
//    * Generate new Polygon wallet (same as Ethereum)
//    */
//   generateWallet() {
...
//       console.log('Preparing MATIC transaction:', {
//         from: wallet.address,
//         to: toAddress,
//         amount
//       });
...
//       console.log('✅ MATIC transaction confirmed:', tx.hash);
//       return tx.hash;
//     } catch (error) {
//       console.error('MATIC transaction error:', error.message);
...
//       }));
//     } catch (error) {
//       console.error('Error getting MATIC transaction history:', error.message);
//       return [];
//     }
//   }
...
//         estimatedFee: ethers.formatEther(gasCost) + ' MATIC'
//       };
//     } catch (error) {
